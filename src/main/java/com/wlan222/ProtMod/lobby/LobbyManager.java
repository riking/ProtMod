...
public class LobbyManager {
	 ...
	 *            Unique Game ID
	 * @param pl
	 *            The ProtMod Plugin ( to manage stuff )
	 * @param yourpl
	 *            Your Plugin
	 */
	 ...
	 * 
	 * @param lobbyid
	 *            A unique id needed for config files
	 */
	 ...
	 * 
	 * @param pl
	 *            Your Plugin or null if you want the global token system. Read
